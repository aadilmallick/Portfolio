...
export default abstract class BetterWebComponent<
...
> extends HTMLElement {
  ...
  constructor(options: {
    ...
    this.template = BetterWebComponent.createTemplate(
      options.templateId,
      options.HTMLContent ??
        (this.constructor as typeof BetterWebComponent).HTMLContent
    );
    ...
    if (options.cssContent) this.styles.textContent = options.cssContent;
      ...
      this.styles.textContent = (
        this.constructor as typeof BetterWebComponent
      ).CSSContent;
  }
